/**
 * apps/web — Endpoint webhook Stripe Platform (Lot 5, ADR-010 §9, §14).
 *
 * URL : /api/webhooks/stripe/platform
 *
 * Reçoit les événements PaymentIntent, Charge et Refund des destination charges.
 * Vérifie la signature AVANT toute mutation, lit le corps brut une seule fois,
 * et délègue au use case handleWebhook.
 *
 * Sécurité (ADR-010 §14) :
...
/**
 * Endpoint webhook Stripe Platform.
 *
 * @see ADR-010 §9, §14
 */
