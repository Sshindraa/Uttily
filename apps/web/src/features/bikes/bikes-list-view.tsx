...
import type { UnifiedBikeStatusSummary, UnifiedBikeSummary } from '@uttily/core';
import {
  formatMoneyAmount,
...
export interface BikesListViewProps {
  organizationId: string;
  bikes: UnifiedBikeSummary[];
  canManage: boolean;
}

export function BikesListView({
  organizationId,
  bikes,
  canManage,
}: BikesListViewProps): React.ReactElement {
