...
import type { OperationalBookingSummary, BookingStatus } from '@uttily/core';
import {
  bookingStatusLabel,
...
export interface OperationsBookingsViewProps {
  organizationId: string;
  bookings: OperationalBookingSummary[];
  status: string | string[] | undefined;
  filterError: string | null;
}

export function OperationsBookingsView({
  organizationId,
  bookings,
  status,
  filterError,
}: OperationsBookingsViewProps): React.ReactElement {
  const sp = { status };
