    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      >
        <section aria-labelledby="context-heading">
          <h2
            id="context-heading"
            style={{ fontSize: '1.125rem', fontWeight: 'var(--ut-weight-semibold)', margin: 0 }}
          >
        ...
        >
          <legend style={{ fontWeight: 'var(--ut-weight-semibold)', padding: '0 0.5rem' }}>
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <label
                    ...
                    style={{ fontSize: '0.875rem', fontWeight: 'var(--ut-weight-medium)' }}
                  >
                    Nouvelle quantité :
                  </label>
                  <input
