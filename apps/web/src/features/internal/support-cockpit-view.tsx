...
import type { AuditLogSupportListItem, SupportSearchResult } from '@uttily/core';
import { SupportSearchForm } from './support-search-form';
import styles from './internal.module.css';

export interface SupportCockpitViewProps {
  initialQuery: string;
  searchResults: SupportSearchResult | null;
  recentAudit: readonly AuditLogSupportListItem[];
}

export function SupportCockpitView({
  initialQuery,
  searchResults,
  recentAudit,
}: SupportCockpitViewProps) {
  ...
  return (
    <div className={styles.container}>
      <section className={styles.hero}>
        ...
        <SupportSearchForm initialQuery={initialQuery} />
      </section>
          ...
          <div className={styles.statsGrid}>
            <div className={styles.statCard}>
              ...
              <Link
                ...
                style={{ fontSize: '1.1rem', fontWeight: 'var(--ut-weight-semibold)' }}
              >
