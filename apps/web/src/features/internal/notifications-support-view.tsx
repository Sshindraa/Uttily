...
import type { NotificationSupportListItem } from '@uttily/core';
import { NotificationActionButtons } from './notifications-action-buttons';
import styles from './notifications-support.module.css';

export type NotificationStatusFilter = 'FAILED' | 'PENDING' | 'SENT' | 'CANCELLED';

export interface NotificationsSupportViewProps {
  notifications: readonly NotificationSupportListItem[];
  validStatus: NotificationStatusFilter | undefined;
}

export function NotificationsSupportView({
