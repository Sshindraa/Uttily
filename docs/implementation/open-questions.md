...
| Fournisseur de géocodage final et droits de stockage/cache | G8B-2B géocodage réel | Technique / juridique | Ouvert — ADR-027 verrouille l'architecture local-first et le benchmark local PostgreSQL/Photon/IGN. Le moteur final et ses droits de stockage restent à décider après mesures ; cela ne bloque pas les destinations canoniques déjà activées. |
