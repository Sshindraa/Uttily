...
| Slug et activation du pédalo | Lot d'activation pédalo | Produit / direction / technique | **Préparé par ADR-036 le 2026-09-01** — `pedalboat` est proposé comme slug unique `INACTIVE`, avec « Pédalo » / « Pedal boat », présentation nautique générique et capacité éventuelle dans les attributs existants. Aucune catégorie, migration, fixture publiée, recherche, onboarding ou réservation n'est exposée ; confirmation du contrat et décision d'activation encore requises. |
