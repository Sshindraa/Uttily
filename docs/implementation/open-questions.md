...
| Contrat des blocages manuels récurrents | Lot d'implémentation après préparation ADR-038 | Produit / technique / opérations | **Ouvert — ADR-038 propose une V1 hebdomadaire bornée par exemplaire, en fuseau IANA, matérialisée en `MANUAL_BLOCK` et refusant tout conflit ; restent à confirmer la borne maximale, les rôles, les modifications d'occurrences futures et l'absence d'exceptions en V1.** |
