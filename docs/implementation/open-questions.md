...
| Règles précises par catégorie (nombre minimum, vues requises, angles) | G8B-3B4 | Produit / technique | **Partiellement résolu pour le vélo** — trois vues produit acceptées : vélo complet côté transmission, transmission, freins/pneus. ADR-020 conserve le gate technique actuel tant que les slots serveur et l'UI guidée ne sont pas implémentés. Les règles des autres catégories restent ouvertes. |
