...
| 21-U2-D — Taxonomie outdoor fermée | contrat typé serveur : quatre univers, familles et sous-types, statuts `ACTIVE`/`APPROVED_NEXT`/`APPROVED_LATER`/`INTERNAL_FALLBACK`, inconnus `UNSUPPORTED`, modes futurs de compléments | **Livré le 2026-09-01 — ADR-035 ; PR #43 (`4286fe4`), CI complète verte ; aucune donnée, recherche ou publication modifiée** |
