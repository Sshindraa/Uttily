...
| 21-U2-O — Activation pédalo | famille commerciale `pedalboat` `ACTIVE`, migration idempotente 0055, libellés FR/EN, parcours loueur/public génériques, seuil universel de photos, recherche, hold, paiement TEST et réservation ; aucune conversion historique, règle spécialisée, pack ou autre catégorie | **Livré le 2026-09-01 — commits `e2a026d` et `1f91d36`, PR #56 ouverte vers `main`, CI complète verte avec Browser Clerk TEST ; PR non fusionnée** |
