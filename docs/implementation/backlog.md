...
| 21-U2-N — Préparation pédalo | contrat proposé `pedalboat` sous une seule famille inactive ; libellés « Pédalo » / « Pedal boat », capacité éventuelle dans les attributs existants, présentation nautique générique et photos neutres ; aucune migration, fixture publiée, recherche, onboarding ou réservation | **Préparé le 2026-09-01 — ADR-036 ; non exposé et non activé, décision produit requise avant activation** |
