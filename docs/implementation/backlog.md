...
| 21-U2-O — Activation pédalo | famille commerciale `pedalboat` `ACTIVE`, migration idempotente 0055, libellés FR/EN, parcours loueur/public génériques, seuil universel de photos, recherche, hold, paiement TEST et réservation ; aucune conversion historique, règle spécialisée, pack ou autre catégorie | **Livré sur `codex/phase-2-pedalboat-activation` le 2026-09-01 — tests ciblés et typechecks en cours, PR vers `main` à ouvrir ; CI exhaustive et Browser Clerk TEST requis** |
