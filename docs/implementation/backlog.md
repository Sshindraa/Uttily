...
| 21-U2-X — Préparation des blocages manuels récurrents | ADR-038 proposant une série bornée par exemplaire, fuseau IANA explicite, V1 hebdomadaire, matérialisation en `MANUAL_BLOCK`, détection atomique des conflits, cycle de vie idempotent et conservation des occurrences déjà créées ; aucune implémentation, migration ou exposition | **Préparé le 2026-09-02 — ADR-038 `Proposed`, documentation uniquement ; décision produit requise avant le lot d'implémentation** |
