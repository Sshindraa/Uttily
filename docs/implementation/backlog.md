...
| 21-U2-P — Onboarding autonome — premier équipement | parcours guidé catégorie → produit → variante → exemplaire → lieu → tarif → photos → disponibilité → publication pour les huit familles `ACTIVE`, contrôle serveur des familles et de la readiness réservable, checklist bloquante et réservation TEST post-publication ; Photo Coach uniquement pour `bike`, photos neutres ailleurs, sans packs ni opérations groupées | **En cours le 2026-09-02 — implémentation et validations ciblées** |
