...
| 21-U2-L — Préparation paddle | proposer sans imposer le slug futur, inventorier les données existantes, préparer une présentation neutre inactive, documenter les compléments et prouver l'absence d'exposition publique | **En cours le 2026-09-01 — aucune activation, migration, fixture publiée, règle métier ou moteur de complément** |
