...
4. [ ] **Stripe LIVE platform** — configurer l'environnement Stripe LIVE et le garde-fou d'activation conformément aux décisions approuvées ; ne jamais réutiliser un secret TEST.
...
9. [ ] **Safe smoke tests** — exécuter uniquement les scénarios autorisés, avec données et moyens de paiement de test si le runbook l'impose ; ne pas confirmer une réservation commerciale avant tous les sign-offs.
