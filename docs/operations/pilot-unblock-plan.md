...
| `C2C-07` | Sous-traitants / DPA / transferts | `DPO-005` | DPO + juridique | `DECISION_PACK_READY_FOR_DPO_SIGNOFF` (Lot 21-P1C) | Fiches complètes des 6 sous-traitants (Clerk, Stripe, Neon, Cloudflare, Resend, Vercel), bases de transfert DPF/SCC et DPA vérifiés dans [`21-p1c-subprocessors-dpo-005.md`](./21-p1c-subprocessors-dpo-005.md). | Signature formelle du DPO sur les 5 clauses d'arbitrage de sous-traitance et transferts. | Oui |
