 ...
 * Aucun appel à un géocodeur externe. Aucun élargissement de zone.
 *
 * La zone de recherche est définie par la bounding box canonique de la
 * destination ou par un viewport explicitement choisi. Les locations dont le
 * geoPoint tombe dans cette bbox sont candidates. La distance est calculée en
 * mètres via ST_Distance sur le cast geography (SRID 4326).
 */
